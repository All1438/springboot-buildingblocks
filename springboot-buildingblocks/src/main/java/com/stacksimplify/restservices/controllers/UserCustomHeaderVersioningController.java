...
public class UserCustomHeaderVersioningController {
    ...
    @GetMapping(value = "/{id}", headers = "API-VERSION=1") //, cette méthode de gestion sera invoquée uniquement si la requête GET contient un paramètre nommé version avec une valeur égale à 1
    // mettre dans key: version et value: 1 dans POSTMAN ou users/1?version=1
