...
public class UserRequestParameterVersioningController {
    ...
    @GetMapping(value = "/{id}", params = "version=1") //, cette méthode de gestion sera invoquée uniquement si la requête GET contient un paramètre nommé version avec une valeur égale à 1
